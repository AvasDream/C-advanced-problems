...
MODULE_DESCRIPTION("Introduction driver to get used to tools/procedures.\n This driver creates a char device without any associated functions.");
...
static int __init ModInit(void)
{
		...
		if ( alloc_chrdev_region(&device_number,0,1,"hello_kworld")<0) {
		...
		driver_class = class_create( THIS_MODULE, "hello_kworld");
		device_object = device_create(driver_class,NULL,device_number,"%s","hello_kworld");
		return 0;
